...
We can demonstrate the simulation results graphically:
```{r,echo=FALSE}
...
We can demonstrate the simulation results graphically for modified_cor function:
```{r,echo=FALSE}
plot(1:10,square(1:10))
```
